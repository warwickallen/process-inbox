...
var __, addLabel, address, archive, archiveOldNotification, currentDayRange, currentTimeBetween, dispose, getLabel, labels, log, notification_text, notified, notify, olderThan, processHighPriorityRules, processLowPriorityRules, processMail, remLabel, sendMail, t_id, wait;
...
currentDayRange = function(start_day, end_day) {
  var dayNumber;
